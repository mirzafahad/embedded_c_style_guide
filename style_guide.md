# Table of Contents
  ...
  - [6. Module Rules](#6.-Module-Rules)
    - [6.1 Naming](#6.1-Naming)
    - [6.2 Header Files](#6.2-Header-Files)
    - [6.3 Source Files](#6.3-Source-Files)
  - [7. Data Type Rules](#7.-Data-Type-Rules)
    - [7.1 Naming](#7.1-Naming)
    - [7.2 Fixed-Width Integers](#7.2-Fixed-Width-Integers)
    - [7.3 Signed and Unsigned Integers](#7.3-Signed-and-Unsigned-Integers)
    - [7.4 Floating Point](#7.4-Floating-Point)
    - [7.5 Structures and Unions](#7.5-Structures-and-Unions)
    - [7.6 Booleans](#7.6-Booleans)
  - [8. Statement Rules](#8.-Statement-Rules)
    - [8.1 Conditional Statements](#8.1-Conditional-Statements)
    - [8.2 Switch Statements](#8.2-Switch-Statements)
    - [8.3 Loops](#8.3-Loops)
